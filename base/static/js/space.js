;(function() {
  ...
  Game.prototype = {
    ...
    draw: function() {
      ...
      if (this.lost) {
        ...
        screen.fillText("You lost", (gameSize.width*0.8) / 2,(gameSize.height*0.8) / 2);
        screen.font = "20px Lucida Console";
        screen.fillText("Points: " + kills,(gameSize.width*0.8)  / 2, (gameSize.height*0.8)/ 2 + 30);
        ...
        screen.fillText("Points: " + kills, (gameSize.width*0.8), gameSize.height - 12);
      }
  ...
  function initGameStart() {
    if (window.innerWidth > 1200) {
      ...
      screen.canvas.width = screen.canvas.width * 0.8;
      screen.canvas.height = screen.canvas.width * 0.8;
