...
from baseapp.forms.endereco import EnderecoAjaxForm


class EnderecoCreateAjaxView(View):
    '''
   ...
   :URl: http://ip_servidor/pedido/cadastrar/
    ...
    def get(self, request,**kwargs):
        ...
        context = {}
        data = {}
        form = EnderecoAjaxForm()
        context['form'] =  form
        context['url'] = reverse('endereco-ajax-add')
    ...
    def post(self, request):
        ...
        '''
        form = EnderecoAjaxForm(request.POST, request.FILES)
        print(request.FILES)
        print(request.POST)
        if form.is_valid():
            ...
            data['campo_alterar'] = 'id_endereco'
            data['sucesso'] = True
            return JsonResponse(data)
        else:
            print(form.errors)
