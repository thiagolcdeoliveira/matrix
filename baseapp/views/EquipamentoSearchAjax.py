...
class EquipamentoSearchAjaxView(View):
    '''
   ...
   :URl: http://ip_servidor/pedido/cadastrar/
    ...
    def get(self, request,**kwargs):
        ...
        context = {}
        data = {}
        context['url'] = reverse('equipamento-ajax-search')
        context['campo_alterar'] = 'id_equipamento_utilizado'
    ...
    def post(self, request):
        ...
        context['object'] = Equipamento.objects.filter(Q(nome__contains=descricao)|
